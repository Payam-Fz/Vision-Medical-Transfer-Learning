...
BIT_MODULE_PATH = {
    'ResNet-50x1': 'https://www.kaggle.com/models/google/bit/frameworks/TensorFlow2/variations/m-r50x1/versions/1',
...
def bit_embedding(
  ...
  model = hub.KerasLayer(BIT_MODULE_PATH[model_name],
                         trainable=trainable,
