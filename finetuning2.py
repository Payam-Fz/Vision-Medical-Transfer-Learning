...
def main(argv):
  ...
  losses, val_losses, macro_f1s, val_macro_f1s = learning_curves(history, os.path.join(project_folder, './out/figs'))
  ...
  for batch in batched_val_tfds:
    show_prediction(*batch, model, os.path.join(project_folder, './out/figs'))
    break
  ...
  export_path = project_folder + "./out/models/soft-f1_{}".format(t)
